...
class FAProgressBar extends StatefulWidget {
  FAProgressBar(
      ...
      this.progressColor2 = const Color(0xFFFA7268),
...
class AnimatedProgressBar extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color progressColor2 = widget.progressColor2;
    ...
    Widget progressWidget = new Container(
      ...
      gradient: LinearGradient(
        colors: [progressColor, progressColor2],
    ...
    return Directionality(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(widget.borderRadius),
          border: Border.all(color: Color(0xFF5A4538), width: 2),
        ),
        child: Flex(
